package net.likzerd.vsfmod.block;
...
public class ModBlocks {
    ...
    private static Item registerBlockItem(String name, Block block) {
        return Registry.register(Registries.ITEM, new Identifier(VSFMod.MOD_ID, name),
                new BlockItem(block, new FabricItemSettings()));
    }
    public static void registerModBlocks() {
        VSFMod.LOGGER.info("Registering Modblocks for " + VSFMod.MOD_ID);
    }
}
